...
class Apple:
    def __init__(self, x ,y,state):
        ...
        self.y = y
        self.state = state
        self.color = pygame.color.Color("orangered")   
...
class snake:
    ...
    def draw(self,screen):
        pygame.draw.rect(screen,pygame.color.Color("blue"), (self.stack[0].x , self.stack[0].y, 
        ...
        while(counter < len(self.stack)):
            if(self.stack[counter].color == "NULL"):
                counter +=1
                continue
            pygame.draw.rect(screen , pygame.color.Color("crimson"), (self.stack[counter].x,
